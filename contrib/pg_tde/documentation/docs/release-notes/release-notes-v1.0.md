...
And **stable** for encrypting relational data in PostgreSQL using [Transparent Data Encryption (TDE)](../index/about-tde.md). This milestone brings production-level data protection to PostgreSQL workloads.
