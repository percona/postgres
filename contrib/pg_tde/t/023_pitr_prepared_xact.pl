...
$node_primary->safe_psql('postgres',
	"SELECT pg_tde_create_key_using_global_key_provider('global_test_key_ptp', 'global_key_provider');");
$node_primary->safe_psql('postgres',
	"SELECT pg_tde_set_server_key_using_global_key_provider('global_test_key_ptp', 'global_key_provider');");
$node_primary->safe_psql('postgres',
	"SELECT pg_tde_add_database_key_provider_file('local_key_provider', '/tmp/local_keyring.file');");
$node_primary->safe_psql('postgres',
	"SELECT pg_tde_create_key_using_database_key_provider('local_test_key_ptp', 'local_key_provider');");
$node_primary->safe_psql('postgres',
	"SELECT pg_tde_set_key_using_database_key_provider('local_test_key_ptp', 'local_key_provider');");
