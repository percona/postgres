...
SELECT pg_tde_set_default_key_using_global_key_provider('default-key', 'file-provider', 'generate_if_not_exists');
SELECT pg_tde_verify_default_key();
...
SELECT pg_tde_set_default_key_using_global_key_provider('new-default-key', 'file-provider', 'generate_if_not_exists');
